...
class EntityItemHelper {
	static function fromPost() {
		if (isset($_POST['name']) && isset($_POST['entity']) && isset($_POST['classification']) && isset($_POST['value']) && isset($_POST['description'])  && isset($_POST['location']) && isset($_POST['flags'])) {
			$entity = new CEntity($_POST['name'], $_POST['module'], $_POST['classification'], $_POST['value'], $_POST['description'], $_POST['flags']);
