                    ...
                    <div class="row">
                        ...
                        <div id='contactData'>
                            ...
                            <table
                                    ...
                                    data-url="<?php echo Mt::$appRelDir ?>/Helpers/FetchPeople">
                                <thead>
                                <tr>
...
HtmlHelper::PageFooter(array("Assets/js/countries-select2.js", "Assets/js/Person.js", "Assistant/Js/NewPerson.js"));
HtmlHelper::PageEndX();
