...
switch ($rq) {
    ...
    case 'fetchHeaders':
        ...
        break;
    case 'fetchHeadersUni':
        if (isset($_POST['start']) && isset($_POST['limit'])) {
            $start = intval($_POST['start']);
            $limit = intval($_POST['limit']);
            $box = isset($_POST['box']) ? $_POST['box'] : "inbox";
            if ($limit >0) {
                CMessage::fetchUni(0, 10, true);
                die();
            }
            CStatus::jsonError();
        }
    ...
    case 'setEmailSettings':
        ...
        if (isset($_POST['incomingServer']) || isset($_POST['incomingSecurity']) || isset($_POST['incomingDelivery']) || isset($_POST['incomingPort']) || isset($_POST['outgoingServer']) || isset($_POST['outgoingSecurity']) || isset($_POST['outgoingDelivery']) || isset($_POST['outgoingPort']) || isset($_POST['username']) || isset($_POST['password'])) {
