    ...
    <!--icon css-->
    <link rel="stylesheet" type="text/css" href="<?= Mt::$appRelDir ?>app/assets/css/font-awesome.css">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="error-section">
                    ...
                    <a href="../index.html" class="btn btn-normal">back to home</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="news-latter">
          <div class="modal-bg">
            ...
            <div class="imd-wrraper">
                <img src="assets/images/layout-2/product/3.jpg" alt="newsletterimg" class="img-fluid bg-img">
            </div>
            </div>
          </div>
        </div>
